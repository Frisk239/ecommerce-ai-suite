...
**从「工程上经得起 grill」到「产品上立得住」**：商家第一次打开就能自己上架商品；顾客的第一问（卖什么/多少钱/找真人）不再被拒或被困；操作者对店铺的客服表现有一眼可见的仪表。治理闭环（三态/版本锚定/缺口验证闸——竞品确认的独有优势）作为底座不变，本阶段全部新增面都接进既有治理/血缘/审计，不开第二套体系。
...
- **评测纪律延续**：任何动检索/生成路径的刀必须 before/after 同报告（`docs/research/rag-eval-report.md`）；每刀 CI 全量绿。
