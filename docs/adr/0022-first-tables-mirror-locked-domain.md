...
| `assets` | 0002 资产三态；0006 当前已发布版本指针 | id、kind（本刀仅 document）、status（ingested/pending_review/published，映射已接入/待人洗/已发布）、current_published_version_id 可空指针（0006：身份稳定指针可前移） |
