...
export default function CoachPage() {
  ...
  return (
    <div>
      <PageHeader
        title="业务能力 · 销售考核"
        desc="上岗前用真实顾客场景做模拟考核：题库从「已发布」对话动态推导（confirmed QA 对逐题，弃权/空则转写首问兜底），未发布的对话不进题库。单轮作答后由厂商模型按三维 rubric（口径准确 40 / 证据贴合 30 / 服务语气 30）打分——打分无降级，底座不可用时该次记「未评分」，可重新评分。考核记录不是中台对象，只在本页回放。"
      />
